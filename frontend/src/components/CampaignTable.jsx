...
const CampaignTable = () => {
  ...
  return (
    <div className="mt-8">
                    ...
                    <tr key={index} className="hover:bg-slate-50 border-b border-slate-200">
                      ...
                      <td className="px-4 py-1.5">
                        ...
                        <td className="p-4 py-1.5">
                          <div>
                              <p className="text-black text-sm font-bold">{campaign.message.slice(0, 40)}...</p>
                          </div>
                        </td>
                        <td className="p-4 py-1.5">
                          <div>
                        ...
                        <td className="p-4  flex items-center gap-x-3">
                          ...
                          <button className="border border-red-500 text-red-500 rounded-md text-xs px-2 py-0.5 font-semibold">Delete</button>
                        </td>
                    </tr>
      ...
      <ViewReportModal isOpen={isOpen} onClose={onClose} title={selectedCampaign?.title} message={selectedCampaign?.message} recipients={selectedCampaign?.recipients} />
    </div>
  );
};
